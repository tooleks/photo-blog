    ...
    mapper.registerResolver("App.Meta", "Vue.MetaInfo", function (meta) {
        return {
            ...
            meta: [
                ...
                {vmid: "og:url", name: "og:url", content: config.url.app + router.currentRoute.fullPath},
                {vmid: "og:site_name", name: "og:site_name", content: value(() => meta.name)},
                {vmid: "og:description", name: "og:description", content: value(() => meta.description)},
                {vmid: "og:image", name: "og:image", content: value(() => meta.image)},
